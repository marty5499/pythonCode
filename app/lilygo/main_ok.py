...
# smart
# esp = ESPNow(b'\x5c\xcf\x7f\x81\x05\x3c') # broadcast 60
# esp = ESPNow(b'\x5c\xcf\x7f\x81\x00\x6e') # broadcast 61
# esp = ESPNow(b'\x5c\xcf\x7f\x81\x00\x0f') # broadcast 62
# esp = ESPNow(b'\x5c\xcf\x7f\xd3\x26\xab')  # broadcast 63
# esp = ESPNow(b'\x18\xfe\x34\xd7\x89\xcd') # 72
esp = ESPNow()
esp.recv(callback)
