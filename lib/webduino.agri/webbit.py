...
class WebBit:
    ...
    def _sub_(self, topic, cb):
        self.connect()
        self.board.mqtt.sub(topic, cb)
        # self.board.mqtt.set_last_will(self.topic_report, 'disconnect', retain=True, qos=1)

    def _pub_(self, topic, msg):
        self.connect()
        self.board.mqtt.pub(topic, msg)
